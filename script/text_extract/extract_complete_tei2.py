...
# -*- encoding: utf-8 -*-
'''
@File      :   extract_complete_data_tei2.py
@Create on :   2022/03/25 16:10:49
@Revise on :   2022/04/14 10:36:11
@Author    :   Heng Yang
@Version   :   1.0
...
csv.to_csv('../../working_dir/metadata/temp/metadata_tei2.csv',index=False)
print("Done with csv")
