...
file_to_csv = 'corp_methal_tei2.csv'
...
haut_outdir = Path('data/tei2/haut_rhin/corpus/')
bas_outdir = Path('data/tei2/bas_rhin/corpus/')
...
csv.to_csv('corp_methal_tei2_comp.csv',index=False)
print("Done with csv")
