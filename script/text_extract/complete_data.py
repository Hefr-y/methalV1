...
import pandas as pd
file_to_metadata = 'corpus-methal-all/autres/md/personnages.ods'
file_to_csv = 'metadata_avec_text_brut.csv'
...
haut_outdir = Path('data/methal_corpus/haut_rhin/corpus/')
bas_outdir = Path('data/methal_corpus/bas_rhin/corpus/')
...
csv.to_csv('corpus_methal_metadata.csv')
print("Done with csv")
